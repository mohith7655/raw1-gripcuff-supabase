...
function getMockAllVideos(): Video[] {
  const categorizedVideos = [
    ...
    // General Health (6)
    { title: 'One Leg Balance', duration: 10, category: 'GeneralHealth', difficulty: 'Beginner',
      purpose: { summary: 'Single-leg balance training strengthens the stabilising muscles of the foot, ankle, and hip while sharpening the proprioceptive feedback that keeps you steady and fall-free as you age.', benefits: ['Improves ankle and hip stability to reduce the risk of trips and falls', 'Sharpens proprioception and joint-position sense for everyday coordination', 'Builds foot and lower-leg strength that supports pain-free standing and walking'] } },
    { title: 'Heel-to-Toe Walk', duration: 10, category: 'GeneralHealth', difficulty: 'Beginner',
      purpose: { summary: 'A gentle gait drill that trains dynamic balance and coordination by narrowing your base of support, reinforcing the neuromuscular control needed for confident, steady movement.', benefits: ['Trains dynamic balance for safer walking on uneven surfaces', 'Improves gait rhythm and lower-limb coordination', 'Strengthens the small stabilisers of the ankle and foot'] } },
    { title: 'Posture Reset Drill', duration: 10, category: 'GeneralHealth', difficulty: 'Beginner',
      purpose: { summary: 'A quick postural routine that counteracts the rounded-shoulder, forward-head position from desk and phone use, realigning the spine and easing everyday neck and back tension.', benefits: ['Reverses forward-head and rounded-shoulder desk posture', 'Relieves chronic neck and upper-back tension', 'Reactivates deep postural muscles for effortless upright alignment'] } },
    { title: 'Deep Breathing Reset', duration: 10, category: 'GeneralHealth', difficulty: 'Beginner',
      purpose: { summary: 'Diaphragmatic breathing lowers resting heart rate and activates the parasympathetic nervous system, improving stress resilience, sleep quality, and overall cardiovascular health.', benefits: ['Activates the parasympathetic nervous system to lower stress and blood pressure', 'Improves oxygen exchange and breathing efficiency', 'Supports better sleep and daytime focus through nervous-system regulation'] } },
    { title: 'Full-Body Mobility Flow', duration: 10, category: 'GeneralHealth', difficulty: 'Beginner',
      purpose: { summary: 'A low-intensity mobility sequence that takes every major joint through its natural range, maintaining the joint health, circulation, and freedom of movement that underpin long-term wellbeing.', benefits: ['Maintains healthy range of motion across all major joints', 'Boosts circulation and joint synovial fluid for pain-free movement', 'Reduces everyday stiffness and supports active longevity'] } },
    { title: 'Core Stability Basics', duration: 10, category: 'GeneralHealth', difficulty: 'Beginner',
      purpose: { summary: 'Foundational core activation trains the deep abdominal and spinal stabilisers that protect the lower back, improve posture, and make every daily movement safer and more efficient.', benefits: ['Builds deep-core support that protects the lower back in daily life', 'Improves balance and posture through a stronger trunk', 'Reduces back-pain risk by teaching safe bracing mechanics'] } },
  ];
